...
module.exports = {
   ...
   .addStringOption(option => option.setName('query').setDescription('The query 
    for the AI!').setRequired(true)),
   ...
   async execute (interaction) {
      ...
      let value = await page. Seval("[data-testid="final-bot-response"1", async (elements) => {
